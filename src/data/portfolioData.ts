...
export const PERSONAL_INFO = {
  ...
  linkedin: "https://www.linkedin.com/in/ravindran-s-982702327",
...
export const ACHIEVEMENTS: AchievementItem[] = [
  ...
  },
  {
    ...
    date: "Jul–Oct 2025",
    metric: "75% Score",
    badgeText: "12-week course",
    description: "Completed comprehensive coursework on IoT architecture, edge inference, and sensor networks with Elite certification.",
  },
  {
    id: "nptel-data",
    ...
    metric: "70% Score",
    badgeText: "12-week course",
    description: "Certified in Python-based data analytics, data manipulation, and visualization techniques.",
  },
  {
    id: "mongodb-certs",
    title: "MongoDB Specialized Certifications",
    category: "Certification",
    organization: "MongoDB",
    metric: "Multi-Certified",
    badgeText: "Database & AI",
    description: "Earned certifications in RAG with MongoDB, AI Data Strategy, Vector Search Fundamentals, AI Agents, and MongoDB Basics for Students.",
  },
];
